...
const authenticationV2 = aSyncHandler(async (req, res, next) => {
    ...
    // Step 3
    if (req.headers[_HEADER.REFRESHTOKEN]) {
        try {
            const refreshToken = req.headers[_HEADER.REFRESHTOKEN];
            ...
            console.log("Error retrieving refresh token from req.headers: " + error.message);
            throw error;
        }
    }
